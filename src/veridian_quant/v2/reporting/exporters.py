        ...
        rows.append(
            {
                ...
                "pullback_lookback": metadata.get("pullback_lookback"),
                "sma_fast_window": metadata.get("sma_fast_window"),
                "sma_slow_window": metadata.get("sma_slow_window"),
                "sma_slope_lookback": metadata.get("sma_slope_lookback"),
                "min_pullback_return_pct": metadata.get(
                    "min_pullback_return_pct"
                ),
                "max_pullback_return_pct": metadata.get(
                    "max_pullback_return_pct"
                ),
                "min_drawdown_20d_pct": metadata.get("min_drawdown_20d_pct"),
                "max_drawdown_20d_pct": metadata.get("max_drawdown_20d_pct"),
                "max_atr_pct": metadata.get("max_atr_pct"),
                "max_atr_expansion_5d_pct": metadata.get(
                    "max_atr_expansion_5d_pct"
                ),
                "require_recovery_day": metadata.get("require_recovery_day"),
            }
        )
    return rows
