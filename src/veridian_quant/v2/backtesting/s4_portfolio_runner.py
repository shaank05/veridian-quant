"""Multi-symbol S4 compression breakout portfolio backtest runner."""
...
from veridian_quant.v2.strategies.s4_entropy_volatility_compression_breakout import (
    ...
    validate_s4_strategy_variant,
)


S4_CANDIDATE_RANKING_NONE = "none"


@dataclass(frozen=True, slots=True)
class _PendingTrade:
    """Accepted S4 trade waiting for realized ledger application."""
...
def run_s4_portfolio_backtest(
    ...
    """Run a deterministic multi-symbol S4 research portfolio backtest."""

    strategy_variant = validate_s4_strategy_variant(strategy_variant)
    ...
    for symbol in symbols:
        ...
        try:
            ...
            progress.info(
                f"Generated S4 signals for {symbol}: rows={len(backtest_data)} "
    ...
    progress.info(
        "Finished S4 signal generation in "
    ...
    progress.info(
        "Finished S4 portfolio execution in "
    ...
    return PortfolioBacktestResult(
        ...
        candidate_ranking_mode=S4_CANDIDATE_RANKING_NONE,
    )
